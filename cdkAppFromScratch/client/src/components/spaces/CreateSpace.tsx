...
export default function CreateSpace({ dataService }: CreateSpaceProps) {
  ...
  function renderPhoto() {
    if (photo) {
      // URL.createObjectURL method is often used to create a temporary URL to an in-memory object like an image or a file that the user has uploaded, so that this object can be used in other web APIs that require a URL, such as the src attribute of an img tag.
